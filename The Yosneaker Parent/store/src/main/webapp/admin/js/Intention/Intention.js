var intention={
		serverUrl:'/admin/intention',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="intention.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="intention.del('+val+')">删除</a>';
		},
		openCreate:function(){
